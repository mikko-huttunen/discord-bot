...
import { weeklyParticipant } from "../models/weekly_participant_schema.js";

let participants;

export const handleWeekly = (msg) => {
...
const addParticipant = async (msg) => {
    await weeklyParticipant.findOneAndUpdate(
...
const removeParticipant = async (msg) => {
    await weeklyParticipant.findOneAndDelete(
        { user: msg.author.username + "#" + msg.author.discriminator },
    ).then(response => {
        if (response) {
            console.log(response);
...
const getParticipants = async () => {
    return await weeklyParticipant.find(
        {},
